...
import com.ying.alipay.util.httpClient.HttpProtocolHandler;
import com.ying.alipay.util.httpClient.HttpRequest;
import com.ying.alipay.util.httpClient.HttpResponse;
import com.ying.alipay.util.httpClient.HttpResultType;
...
public class AlipaySubmit {
    ...
    public static String buildRequest(String ALIPAY_GATEWAY_NEW, Map<String, String> sParaTemp, String strMethod, String strButtonName) {
        ...
        sbHtml.append("<!doctype html><html ><head></head><body><form id=\"alipaysubmit\" name=\"alipaysubmit\" action=\"" + ALIPAY_GATEWAY_NEW
...
//    		request_token = document.selectSingleNode( "//direct_trade_create_res/request_token" ).getText();
    		request_token=document.getRootElement().getStringValue();
    	}
