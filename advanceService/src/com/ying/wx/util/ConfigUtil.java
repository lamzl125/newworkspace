...
public class ConfigUtil {
	...
	//初始化
	public static String APP_ID = "wxb1d4578f52b9924c";//微信开发平台应用id
	public static String APP_SECRET = "09d3fe906f7d263e1bf6f29f9de22906";//应用对应的凭证
	//应用对应的密钥
	...
	public static String PARTNER = "1266716801";//财付通商户号
	public static String PARTNER_KEY = "qwsxedcrfvkmnjuhbjklkijimklnjijs";//商户号对应的密钥
