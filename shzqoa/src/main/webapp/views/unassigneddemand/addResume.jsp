...
function adddemand(){
	...
	$.ajax({
		url:"/demandsigned/demandaddresume.do",
		dataType:'json',
		type:'post',
		data:data,
...
function search(){
	...
	var customerphone = $("#customerphone").val();	 
	 var url =  "/demandsigned/demandNoBindResumeList.do?customername="+encodeURI(encodeURI(customername.trim()))+"&customerphone="+encodeURI(encodeURI(customerphone.trim()));
 ...
 <body>
     ...
     <div style="margin-left:20px;">
		...
		<span>电话： </span>
		<input type="text" class="zyh_txt whh_input"  id="customerphone"  value=${customerphone} >
		<input type="button" class="zyh_btn" value="查询" onclick="search()"> 
     </div>
     <div class="whh_tab_bor">
     		<c:forEach items="${list}" var="cc">
     			<div class="resdiv">
     				<input type="checkbox" name="customercode" value="${cc.CustomerCode}"/>${cc.CustomerName }&nbsp;&nbsp;|${cc.CustomerTel}
     			</div>
          	</c:forEach>
