...
<html>
 <head> 
  ...
  function togetListBypage(page){
  	  var url = "/workersign/toFollowWorkerList.do?page="+page;
  	  window.location.href=url;
  }
  function tonextpageInfo(page){
  	  var url = "/workersign/toFollowWorkerList.do?page="+(page+1);
  	  window.location.href=url;
  }
  ...
  function topageInfo(){
  	  ...
  	  var url = "/workersign/toFollowWorkerList.do?page="+topage;
  	  window.location.href=url;
  }
  </script>
	...
	<div id="content-header">
	    <div id="breadcrumb"> 
	    	<a href="index.html" title="待招人员" class="tip-bottom"><i class="icon-home"></i>待招人员</a>
	     	<a href="" title="跟踪普工列表" class="current">跟踪普工列表</a>
	    </div>
	</div> 
	          ...
	          <div style="width:100%;overflow:auto;">
	            <table class="table table-bordered table-striped with-check" style="width:2000px;">
	            	<colgroup>
	                  ...
	                  <col style="width:3%;"> <col style="width:6%;"><col style="width:2%;">
	              </colgroup>
	              <thead>
	                <tr>
	                  <th>#</th><th>时间</th><th>姓名</th><th>性别</th><th>电话</th><th>年龄</th><th>籍贯</th><th>身份证号</th>
	                  <th>是否体检</th><th>预计反费时间</th><th>状态</th><th>反费金额</th><th>反费时间</th>
	                  <th>是否结清</th><th>添加人</th><th>加入工厂</th><th>夜班要求</th><th>操作</th>
	                </tr>
	              </thead>
	              <tbody>
	              	<c:if test="${fn:length(workerlist) == 0}">
						<tr><td colspan="12" style="text-align: center">没有需要跟踪的普工信息</td></tr>
					</c:if>
