...
<html>
 <head> 
  ...
  function togetListBypage(page){
	  var resumeSourceId= $("#resumeSourceId").val();
	  var userCode  = $("#userCode").val();
	  var optype = $("#optype").val();
  	  var url = "/resume/customerlist.do?page="+page;
  	  if(resumeSourceId!=null && resumeSourceId!=""){
  		url += "&resumeSourceId="+resumeSourceId;
  	  }
  ...
  function tonextpageInfo(page){
	  ...
	  var userCode  = $("#userCode").val();
	  var optype = $("#optype").val();
  	  var url = "/resume/customerlist.do?page="+(page+1);
  	  if(resumeSourceId!=null && resumeSourceId!=""){
  		url += "&resumeSourceId="+resumeSourceId;
  	  }
  	  if(userCode!=null && userCode!=''){
  ...
  function topageInfo(){   
	  ...
	  var optype = $("#optype").val();
  	  ...
  	  var url = "/resume/customerlist.do?page="+topage;
      if(resumeSourceId!=null && resumeSourceId!=""){
  		url += "&resumeSourceId="+resumeSourceId;
  	  }
  	  if(userCode!=null && userCode!=''){
 ...
 <input type="hidden" id="optype" value="${optype}" />
  <input type="hidden" id="resumeSourceId" value="${resumeSourceId}" />
        ...
        <div>
          <div class="clearfix">
            <table class="table table-bordered table-striped with-check">
              <thead>
                	<tr><th>#</th><th>录入人</th><th>简历</th></tr>
              </thead>
              <tbody>
                ...
                <c:forEach  items="${stlist}"  var="worker" varStatus="status">
	                   ...
	                   <td><a href="/customerDatailInfo/toCustomerDatailInfo.do?customercode=${worker.CustomerCode}">${worker.CustomerName}</a></td>
                 	</tr>
                </c:forEach>
              </tbody>
            </table>
