        ...
        <div>
          <div class="clearfix">
            <table class="table table-bordered table-striped with-check whh_table">
              <tbody>
                 <tr>
                   <td width="50%" class="whh_right"><span class="xing">*</span><c:if test="${schoolType==1}">培训学校名称</c:if><c:if test="${schoolType==2}">学校名称</c:if>：</td>
                   <td><input type="text" class="whh_input" placeholder="请输入名称" id="schoolName" />  </td>
                 </tr>
                  <tr>
                   <td class="whh_right"><span class="xing">*</span><c:if test="${schoolType==1}">培训学校地址</c:if><c:if test="${schoolType==2}">学校地址</c:if>：</td>
