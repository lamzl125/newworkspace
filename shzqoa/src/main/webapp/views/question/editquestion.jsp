      ...
      <div class="widget-box">
        <div class="widget-content nopadding">
          <form action="#" method="get" class="form-horizontal">
              ...
              <div class="controls">
                <input type="text" class="span12" placeholder="问题反馈人" id="problemMaker" value="${info.problemMaker}"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">反映时间 :</label>
              <div class="controls">
                <input type="text" class="span12 zyh_cursor" placeholder="反映时间" onclick="WdatePicker()" id="reflectProblemTime" onfocus="WdatePicker({skin:'whyGreen',maxDate:'%y-%M-%d'})" readonly value="<fmt:formatDate pattern='yyyy-MM-dd' value='${info.reflectProblemTime}' />"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">问题描述:</label>
              <div class="controls">
                <input type="text" class="span12" placeholder="问题描述" id="questionContent" value="${info.questionContent}"/>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                    <select id="personLiable">
                      ...
                      <c:forEach items="${list}" var="personli">
                      		<option value="${personli.usercode}" <c:if test="${info.personLiable==personli.usercode}">selected</c:if>>${personli.realname}-${personli.fullName}</option>
                      </c:forEach>
                    </select>
              </div>
            </div>
            <div class="control-group">
              ...
              <div class="controls">
                <input type="text" class="span12" placeholder="紧急程度" id="urgencyLevel" value="${info.urgencyLevel}"/>
              </div>
            </div>
            <div class="control-group">
              <label class="control-label">预计解决时间 :</label>
              <div class="controls">
                <input type="text" class="span12 zyh_cursor" placeholder="预计解决时间" onclick="WdatePicker()" id="estimatedSettlingTime" onfocus="WdatePicker({skin:'whyGreen',minDate:'%y-%M-%d'})" readonly value="<fmt:formatDate pattern='yyyy-MM-dd' value='${info.estimatedSettlingTime}' />"/>
              </div>
            </div>
