...
function togetListBypage(page){
	...
	var url = "/partjob/demandBindResumeList.do?page="+page+"&customername="+encodeURI(encodeURI($.trim(customername)))+"&demandId="+encodeURI(encodeURI($.trim(demandId)));
	window.location.href=url;
}
function tonextpageInfo(page){
	var customername = $("#searchname").val();
	var demandId = $("#demandId").val();
	var url = "/partjob/demandBindResumeList.do?page="+(page+1)+"&customername="+encodeURI(encodeURI($.trim(customername)))+"&demandId="+encodeURI(encodeURI($.trim(demandId)));
	window.location.href=url;
}
...
function topageInfo(){
	...
	var customername = $("#searchname").val();
	var demandId = $("#demandId").val();
	var url = "/partjob/demandBindResumeList.do?page="+topage+"&customername="+encodeURI(encodeURI($.trim(customername)))+"&demandId="+encodeURI(encodeURI($.trim(demandId)));
	window.location.href=url;
}
function search(){
	var customername = $("#searchname").val();
	var demandId = $("#demandId").val();
	var url = "/partjob/demandBindResumeList.do?customername="+encodeURI(encodeURI($.trim(customername)))+"&demandId="+encodeURI(encodeURI($.trim(demandId)));
	window.location.href=url;
}
</script>
 <body>
                ...
                <tbody>
                	...
                	<c:forEach items="${list }" var="cc">
	                  <tr>
	                   ...
	                   <td>${fn:substring(cc.CustomerTel, 0, 3)}****${fn:substring(cc.CustomerTel, 7, -1)}</td>
	                 </tr>
                 </c:forEach>
                </tbody>
              </table>
