...
public class DemandFollowdController {
	...
	public ModelAndView toFollow(@RequestParam(value = "demandResumeId", defaultValue = "") String demandResumeId){
		...
		//查询最后跟踪状态
		DemandResumeFollow follow = demandResumeFollowService.stllastestfollowBydrid(demandResumeId);
	...
	public ReturnDate saveFollow(
			...
			@RequestParam(value = "sendResumeStatus", defaultValue = "") Integer sendResumeStatus,
			@RequestParam(value = "screeningResumesStatus", defaultValue = "") Integer screeningResumesStatus,
			@RequestParam(value = "noticeInterviewStatus", defaultValue = "") Integer noticeInterviewStatus,
			@RequestParam(value = "interviewResultStatus", defaultValue = "") Integer interviewResultStatus,
			@RequestParam(value = "picUrl", defaultValue = "") String picUrl,
			@RequestParam(value = "retestStatus", defaultValue = "") Integer retestStatus,
			@RequestParam(value = "arrangeEntryStatus", defaultValue = "") Integer arrangeEntryStatus,
			@RequestParam(value = "retestResultStatus", defaultValue = "") Integer retestResultStatus,
			@RequestParam(value = "remark", defaultValue = "") String remark,
			
			@RequestParam(value = "interviewtime", defaultValue = "") String interviewtime,
			@RequestParam(value = "retesttime", defaultValue = "") String retesttime,
			@RequestParam(value = "joinprotime", defaultValue = "") String joinprotime,
			HttpServletRequest request
			) throws Exception{
		...
		if(interviewtime!=null && !"".equals(interviewtime)){
			follow.setInterviewTime(sf.parse(interviewtime));
		}
		if(retesttime!=null && !"".equals(retesttime)){
			follow.setInterviewTime(sf.parse(retesttime));
		}
		if(joinprotime!=null && !"".equals(joinprotime)){
			follow.setJoinProjectTime(sf.parse(joinprotime));
		}
		if(demandResumeFollowService.insertDemandResumeFollow(follow,request)>=0){
