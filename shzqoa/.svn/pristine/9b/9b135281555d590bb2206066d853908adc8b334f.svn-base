...
<html>
 <head> 
  ...
  function save(){
	  var enterpriseContactsId = $("#enterpriseContactsId").val();	 
	 ...
	 var data = {
			 ...
			 "job":job.trim(),"contactsStatus":contactsStatus.trim(),"enterpriseContactsId":enterpriseContactsId.trim(),
	 }
	 $.ajax({
         type: "post",
 ...
 <body>
   <input type="hidden" class="whh_input" id="enterpriseContactsId" value="${info.enterpriseContactsId}"/>
            ...
            <table class="table table-bordered table-striped with-check whh_table">
              <tbody>
                  <tr>
                   ...
                   <td><input type="text" class="whh_input" placeholder="输入姓名" id="contactsName" value="${info.contactsName}"/>  </td>
                 </tr>
                  <tr>
                   <td  class="whh_right">联系电话：</td>
                   <td><input type="text" class="whh_input" placeholder="请输入联系电话" id="contactsPhone"  value="${info.contactsPhone}"/></td>
                 </tr>
                 <tr>
                   <td class="whh_right">办公电话：</td>
                   <td><input type="text" class="whh_input" placeholder="请输入办公电话" id="contactsTel"  value="${info.contactsTel}"/></td>
                 </tr>
                 <tr>
                   <td class="whh_right">QQ：</td>
                   <td><input type="text" class="whh_input" placeholder="请输入QQ" id="contactsQQ" value="${info.contactsQQ}"/></td>
                 </tr>
                 <tr>
                   <td class="whh_right">微信号：</td>
                   <td>
                   		<input type="text" class="whh_input" placeholder="请输入微信号" id="contactsWeiXin" value="${info.contactsWeiXin}"/>
                   </td>
                 </tr>
                 <tr>
                   <td class="whh_right">职位：</td>
                   <td>
                   		<input type="text" class="whh_input" placeholder="请输入职位" id="job" value="${info.job}"/>
                   </td>
                 </tr>
                 <tr>
                   ...
                   <td>
		                   ...
		                   <label class="whh_label"><input type="radio" name="contactsStatus"  value="2" <c:if test="${info.contactsStatus==2}">checked</c:if>/>否</label>
		                   <label class="whh_label"><input type="radio" name="contactsStatus"  value="1" <c:if test="${info.contactsStatus==1}">checked</c:if>/>是</label>
	                   </div>
